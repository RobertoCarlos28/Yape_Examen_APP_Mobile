package booking.userinterface.info_booking;
...
public class InfoBookingPages {
    ...
    public static final Target LBL_PRECIO_SUMMARY_TOTAL_VALUE = Target.the("label with the summary total precio value")
